...
for image_set in sets:
    ...
    if not os.path.exists('VOCdevkit/VOC2007/dataSet_path/'):
        os.makedirs('VOCdevkit/VOC2007/dataSet_path/')
    list_file = open('VOCdevkit/VOC2007/dataSet_path/%s.txt' % (image_set), 'w')
